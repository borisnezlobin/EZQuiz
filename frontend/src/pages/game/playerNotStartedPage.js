    ...
    return (
        <div>
            ...
            <div className="w-full h-full min-w-screen min-h-screen gap-4 flex flex-col justify-center items-center" style = {{position:"absolute", zIndex:"69420", textAlign: "center"}}>
                ...
                <input type="text" className="w-1/3" placeholder="Question" value={question} onChange={(e) => {
                    e.preventDefault();
                    setQuestion(e.target.value);
                }} />
                <input type="text" className="w-1/3" placeholder="Answer" value={answer} onChange={(e) => {
                    e.preventDefault();
