            ...
            <div className="w-full h-full flex flex-row justify-around items-center gap-4">
                <div className="flex flex-col justify-center items-center gap-4">
                    ...
                    <div className="flex flex-col justify-center items-center gap-4 pt-16">
                        <h1 className="text-6xl text-gray-300">2nd</h1>
                ...
                <div className="flex flex-col justify-center items-center gap-4">
                    {/* 1st place */}
                    <div className="flex flex-col justify-center items-center gap-4">
                        <h1 className="text-6xl text-gray-300">1st</h1>
                ...
                <div className="flex flex-col justify-center items-center gap-4">
                    {/* 3rd place */}
                    {players.length > 2 ? 
                        <div className="flex flex-row justify-center items-center gap-4 pt-32">
                            <h1 className="text-6xl text-gray-300">3rd</h1>
