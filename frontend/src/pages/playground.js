...
const Playground = () => {
    ...
    function start() {
        ...
        var particle = {
            ...
            update: function() {
                if (Math.cos(Math.atan((this.y - mouseY)/(this.x-mouseX))) != NaN){
                    this.vx = Math.cos(Math.atan((this.y - mouseY)/(this.x-mouseX))) * this.speed;
                    this.vy = Math.sin(Math.atan((this.y - mouseY)/(this.x-mouseX))) * this.speed;
                }
                this.x += this.vx;
                this.y += this.vy;
                console.log(this.vx+"vx        vy"+this.vy);
            }
        };
